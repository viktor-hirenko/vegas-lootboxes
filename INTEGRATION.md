...
Якщо коротко, для інтеграції достатньо шести кроків. Решта документа — деталі й
довідка.
...
6. **Перевірити** все в пісочниці перед релізом (§9 + URL у §10).
...
1. [Швидкий старт](#1-швидкий-старт) — **[обов'язково]**
2. [Модель взаємодії](#2-модель-взаємодії) — **[обов'язково]**
3. [Передача даних карток: два способи](#3-передача-даних-карток-два-способи) — **[обов'язково]**
4. [Сценарій відкриття картки](#4-сценарій-відкриття-картки) — **[обов'язково]**
5. [Протокол postMessage](#5-протокол-postmessage) — **[обов'язково]**
6. [Query-параметри](#6-query-параметри) — **[довідково]**
7. [Стани карток](#7-стани-карток) — **[довідково]**
8. [Анімації](#8-анімації) — **[довідково]**
9. [Команди пісочниці](#9-команди-пісочниці) — **[довідково]**
10. [Розгортання](#10-розгортання) — **[для деплою]**
