...
//                c{i}_prize (prize type), c{i}_active ("true" -> today variant)
//
// Naming bridge: the URL uses `c{i}_prize`, but the postMessage runtime protocol
// (setContent / setCardState) carries the same value as `prizeType`. `c{i}_active`
// only accepts the literal string "true"; any other value is treated as false.
//
